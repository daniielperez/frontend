(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ImageCropperDataShare = /** @class */ (function () {
         ...
         * @return {?}
         */
        ImageCropperDataShare.prototype.setPressed = /**
         * @param {?} canvas
         * @return {?}
         */
        function (canvas) {
         ...
         * @return {?}
         */
        ImageCropperDataShare.prototype.setReleased = /**
         * @param {?} canvas
         * @return {?}
         */
        function (canvas) {
         ...
         * @return {?}
         */
        ImageCropperDataShare.prototype.setOver = /**
         * @param {?} canvas
         * @return {?}
         */
        function (canvas) {
         ...
         * @return {?}
         */
        ImageCropperDataShare.prototype.setStyle = /**
         * @param {?} canvas
         * @param {?} style
         * @return {?}
         */
    ...
    var CropPosition = /** @class */ (function () {
         ...
         * @return {?}
         */
        CropPosition.prototype.toBounds = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        CropPosition.prototype.isInitialized = /**
         * @return {?}
         */
        function () {
    ...
    var ImageCropperComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
        function () {
            /** @type {?} */
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onTouchMove = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onTouchStart = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onTouchEnd = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onMouseDown = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onMouseUp = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onMouseMove = /**
         * @param {?} event
         * @return {?}
         */
        function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.fileChangeListener = /**
         * @param {?} $event
         * @return {?}
         */
        function ($event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.setImage = /**
         * @param {?} image
         * @param {?=} newBounds
         * @return {?}
         */
        function (image, newBounds) {
            var _this = this;
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.isCropPositionChanged = /**
         * @private
         * @param {?} changes
         * @return {?}
         */
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.updateCropBounds = /**
         * @private
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.getOrientedImage = /**
         * @private
         * @param {?} image
         * @param {?} callback
         * @return {?}
        ...
        ImageCropperComponent.propDecorators = {
            cropcanvas: [{ type: core.ViewChild, args: ['cropcanvas', { static: true },] }],
            fileInput: [{ type: core.ViewChild, args: ['fileInput', { static: false },] }],
            settings: [{ type: core.Input }],
            image: [{ type: core.Input }],
            inputImage: [{ type: core.Input }],
            cropper: [{ type: core.Input }],
            cropPosition: [{ type: core.Input }],
            cropPositionChange: [{ type: core.Output }],
            onCrop: [{ type: core.Output }],
            imageSet: [{ type: core.Output }]
        };
    ...
    var ImageCropperService = /** @class */ (function () {
        ...
        /** @nocollapse */ ImageCropperService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ImageCropperService_Factory() { return new ImageCropperService(); }, token: ImageCropperService, providedIn: "root" });
